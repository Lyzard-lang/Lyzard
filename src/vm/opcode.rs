...
mod opcode_tests {
    ...
    #[test]
    fn test_opcode_display_push_int()   { assert_eq!(format!("{}", Opcode::PushInt(42)), "PUSH_INT     42"); }
    #[test]
    fn test_opcode_display_add()        { assert_eq!(format!("{}", Opcode::Add), "ADD"); }
    #[test]
    fn test_opcode_display_load_local() { assert_eq!(format!("{}", Opcode::LoadLocal(0)), "LOAD_LOCAL   0"); }
    #[test]
    fn test_opcode_display_jump()       { assert_eq!(format!("{}", Opcode::Jump(99)), "JUMP         99"); }
